  ...
  const Component = reactExports.forwardRef(
    ({ className, ...props }, ref) => reactExports.createElement(Icon, {
      ...
      className: mergeClasses(
        "lucide-".concat(toKebabCase(toPascalCase(iconName))),
...
function App() {
  ...
  const handleCalculate = () => {
    ...
    if ([numA, numB, numC].some(isNaN)) {
      setError("Please enter valid numbers in all fields.");
      setResult(null);
      return;
    }
    if (numA === 0) {
      setError("Parameter A cannot be zero.");
      setResult(null);
      return;
    }
    const calculated = isDirect ? numB * numC / numA : numA * numB / numC;
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-4" }, /* @__PURE__ */ React.createElement("div", { className: "w-full max-w-md bg-white rounded-2xl shadow-xl p-8 space-y-6" }, /* @__PURE__ */ React.createElement("div", { className: "text-center" }, /* @__PURE__ */ React.createElement(Calculator, { className: "w-12 h-12 mx-auto text-indigo-600 mb-2" }), /* @__PURE__ */ React.createElement("h1", { className: "text-2xl font-bold text-gray-800" }, "Rule of Three Calculator"), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-500 mt-1" }, "Calculate the fourth parameter using proportionality")), /* @__PURE__ */ React.createElement("div", { className: "space-y-4" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-1" }, "Parameter A"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "number",
      value: a,
  ...
  )), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-1" }, "Parameter B"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "number",
      value: b,
  ...
  )), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-1" }, "Parameter C"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "number",
      value: c,
  ...
  ))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between bg-gray-50 p-3 rounded-lg" }, /* @__PURE__ */ React.createElement("span", { className: "text-sm font-medium text-gray-700" }, "Proportionality"), /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: handleToggle,
      className: "relative inline-flex items-center h-8 rounded-full w-16 transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ".concat(isDirect ? "bg-indigo-600" : "bg-gray-400")
    },
    /* @__PURE__ */ React.createElement("span", { className: "inline-block w-6 h-6 transform bg-white rounded-full transition-transform duration-200 ease-in-out ".concat(isDirect ? "translate-x-1" : "translate-x-9") })
  ), /* @__PURE__ */ React.createElement("div", { className: "flex items-center space-x-2" }, isDirect ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(TrendingUp, { className: "w-4 h-4 text-indigo-600" }), /* @__PURE__ */ React.createElement("span", { className: "text-sm font-medium text-indigo-600" }, "Direct")) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(TrendingDown, { className: "w-4 h-4 text-gray-600" }), /* @__PURE__ */ React.createElement("span", { className: "text-sm font-medium text-gray-600" }, "Inverse")))), /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: handleCalculate,
      className: "w-full bg-indigo-600 text-white font-semibold py-3 rounded-lg hover:bg-indigo-700 transition duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
    },
    "Calculate"
  ), error && /* @__PURE__ */ React.createElement("div", { className: "text-center text-red-600 text-sm font-medium" }, error), result !== null && /* @__PURE__ */ React.createElement("div", { className: "text-center bg-indigo-50 p-4 rounded-lg" }, /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "Result"), /* @__PURE__ */ React.createElement("p", { className: "text-3xl font-bold text-indigo-600" }, result.toFixed(4)))));
}
